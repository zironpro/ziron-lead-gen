...
export function InfoNav() {
	return (
		<div className="relative flex w-full items-center justify-center bg-gradient-to-r from-[#ffc650]/ via-[#ffc650] to-[#ffc650]/ px-4 py-2 sm:px-6 lg:px-8">
			<div className="flex flex-row flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-center sm:gap-3 lg:gap-4">
				{/* <div className="flex shrink-0 items-center gap-1.5 rounded-full bg-[#ffc650] px-3 py-1 shadow-sm">
				...
				<Link
					...
					onClick={(e) => {
						...
						// Optionally update URL without triggering scroll jump
				...
				>
					...
					<ArrowRight className="h-4 w-4 text-[#ffc650] transition-transform group-hover:translate-x-0.5" />
				</Link>
			</div>
		</div>
	);
