			...
			<div className="container mx-auto px-6 lg:px-12 max-w-[1400px]">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-20">
					...
					<div className="flex flex-col gap-10 lg:col-span-2 pr-0 lg:pr-8">
						<div className="flex flex-col items-start gap-6">
							...
							<h2 className="text-xl md:text-2xl font-semibold tracking-tight leading-[1.3] text-slate-900 max-w-md">
								We Build high-converting Digital Experiences That Convert
								Better, Faster.
							</h2>
						</div>
						...
						<div className="flex flex-col gap-6">
							<div>
								<p className="text-xs font-bold text-amber-600 mb-2 tracking-[0.15em] uppercase">
									Email.
								</p>
								<a
									href="mailto:growth@zironpro.ae"
									className="text-lg font-medium text-slate-900 hover:text-amber-500 transition-colors"
								>
									growth@zironpro.ae
								</a>
							</div>
					...
					<div className="flex flex-col gap-4">
						<p className="text-xs font-bold text-amber-600 mb-3 tracking-[0.15em] uppercase">
							Links.
						</p>
						<Link
							href="#"
							className="text-base text-slate-800 hover:text-amber-500 font-medium transition-colors"
						>
							Home
						</Link>
						<Link
