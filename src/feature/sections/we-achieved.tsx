...
export function WeAchieved() {
 ...
 content:"We overhauled the bio, highlights, and visual identity to immediately convey trust and luxury to potential real estate buyers."
 },
 {
 title:"2. Content Strategy Shift",
 content:"Transitioned from generic property listings to engaging video tours, market insights, and educational reels that positioned them as industry authorities."
 },
 {
 title:"3. Targeted Ad Campaigns",
 content:"Deployed precision-targeted Meta ads focusing on high-net-worth individuals and expats actively looking for UAE real estate."
 },
 {
 title:"4. Community Management",
 content:"Implemented a rapid response protocol for DMs and comments, capturing leads while their intent was highest."
 }
 ];
 ...
 Success is never an accident. Discover the exact 4-step framework we used to turn a stagnant social presence into a predictable, high-converting revenue engine.
 </p>
 
 <Button className="bg-amber-500 hover:bg-amber-600 text-white rounded-full px-8 h-12 font-bold shadow-lg shadow-amber-500/20 group w-full sm:w-auto transition-all">
